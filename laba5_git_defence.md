...
## 4.1. Рабочая область (Working Directory)
...
## 5.2. Добавление файлов в индекс
...
## 5.3. Коммит изменений в репозиторий
...
## 5.4. Создание и переключение между ветками
...
## 5.5. Отправка изменений в удалённый репозиторий
...
## 6.2. Способы именования коммитов
- **Комментарии**: 
...
## 8.2. Основные операции с ветками
